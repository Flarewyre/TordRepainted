	...
	public function new(curStage)
	{
		...
		switch (curStage)
		{
			...
			case 'eddhouse':
				...
				var bg:FlxSprite = new FlxSprite(-1254, -800).loadGraphic(Paths.image('backgrounds/' + curStage + '/sky'));
				bg.scrollFactor.set(0, 0);
				bg.antialiasing = true;
				add(bg);

				var front:FlxSprite = new FlxSprite(-752, -1408).loadGraphic(Paths.image('backgrounds/' + curStage + '/front'));
			...
			case 'eddhouseBroke':
				...
				var bg:FlxSprite = new FlxSprite(-665, -505).loadGraphic(Paths.image('backgrounds/' + curStage + '/sky'));
				bg.scrollFactor.set(0, 0);
				bg.antialiasing = true;
				add(bg);
